// 注: process.env.XX是Vercel的环境变量，配置方式见：https://zhangyichen701.notion.site/147bb2d774db45e79887d12f97f19812?v=23cd9e9d49c84b2da4bcee6abe98dda0
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '147bb2d774db45e79887d12f97f19812',
  ...
  AUTHOR: 'yczhang', // 作者
  BIO: '一个普通的大学生', // 作者简介
  LINK: 'https://github/zyc2806', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'xmuyichen@stu.xmu.edu.cn', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/zyc2806', // 你的github个人主页
